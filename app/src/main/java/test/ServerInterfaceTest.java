...
public class ServerInterfaceTest  extends ActivityInstrumentationTestCase2<MainActivity> {
    ...
    protected void setUp() throws Exception {
        super.setUp();
        Thread.sleep(1000);
        strOriginalUserID = Snapdirect.getPreferences().strUserID;
        Snapdirect.getPreferences().strUserID = strMockUserID;
    }

    @Override
    protected void tearDown() throws Exception {
        super.tearDown();
        Snapdirect.getPreferences().strUserID = strOriginalUserID;
