...
public class PhoneUtils {
    ...
    private static String getCountryCode(){
        return Snapdirect.getPreferences().strCountryCode;
    }

    public static String getCountryCode(String strPhone){
        String strCode = Snapdirect.getMainActivity().getResources().
    ...
    public final static String getPhoneNumber() {
        TelephonyManager tm =  (TelephonyManager)
                Snapdirect.getMainActivity().getSystemService(Context.TELEPHONY_SERVICE);
        String mPhoneNumber = "";
